    ...
    <div className=' flex flex-col items-center justify-center px-10 pt-10 pb-10 bg-gray-100 '>
        <div className=' flex flex-col items-center justify-center bg-white rounded-xl px-10 md:flex-row md:px-20 md: py-20'>
            <div className=' flex flex-col items-center justify-center'>
                <img src="/sprint.png" alt="" />
            </div>
            <div className=' flex flex-col items-center justify-center'>
            <h1 className=' flex items-center justify-center text-4xl font-extrabold gap-2'>Sprint <span className=' text-xs font-sans font-bold text-blue-300 rounded-2xl py-1 px-2 bg-blue-100'>Speed Task</span></h1>
             <p className=' text-sm font-sans mt-0 mb-0 text-center text-gray-300'>Trains the skill of fast translation. You have to choose if the translation corresponds to the suggested word.</p>
